<div class="row">
  <div class="col-md-12">
    <h4 class="m-b-lg">
      Eğitim Listesi
      <a href="<?= base_url("courses/new_form") ?>" class="btn pull-right btn-outline btn-success btn-xs"><i
      ...
      <?php if (empty($items)): ?>
        <div class="alert alert-info text-center">
          <p>Burada herhangi bir veri kaydı bulunmamaktadır. Eklemek için lütfen <a
              href="<?= base_url("courses/new_form") ?>" class="">tıklayınız</a>.
          </p>
        </div>
      <?php else: ?>
          ...
          <?php foreach ($items as $item): ?>
            <tr id="ord-<?= $item->id ?>">
              ...
              <td>
                ...
                <a href="<?= base_url("courses/update_form/$item->id") ?>" class="btn btn-info btn-xs btn-outline"><i
