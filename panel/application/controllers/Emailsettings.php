...
class Emailsettings extends CI_Controller
{
  ...
  public function save()
  {
    ...
    $this->form_validation->set_rules("from", "Nerden Gidecek (from)", "required|trim|valid_email");
    $this->form_validation->set_rules("to", "Nereye Gidecek(to)", "required|trim|valid_email");
