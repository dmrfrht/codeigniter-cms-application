...
class Settings extends CI_Controller
{
  ...
  public function index()
  {
    ...
    if ($item) $viewData->subViewFolder = "update";
    else $viewData->subViewFolder = "no_content";
  ...
  public function save()
  {
    ...
    $this->form_validation->set_rules("fax_1", "Fax 1", "required|trim");
    ...
    if ($validate) {
      ...
      $file_name = convert_to_seo($this->input->post("company_name")) . '.' . pathinfo($_FILES["logo"]["name"], PATHINFO_EXTENSION);
